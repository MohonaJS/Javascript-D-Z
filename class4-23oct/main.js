/* const fruits = ["banana", " apple", " peyara", " orange"," halon"];

for(let i = 0; i < fruits.length; i++){
    document.write("Fruits" + (i+1) + " " + fruits[i] + "</br>");
...
/* country.shift("denmark")
country.unshift("khan") */
// country[] = "india";
/* country.push("dubai");

country.pop(); */ // tar bort sista value
